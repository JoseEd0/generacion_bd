...
def generar_csvs():
    ...
    compras_membresia = []
    for jugador in df_jugadores.sample(n=50000)['Nombre']:  # 50000 jugadores compran membresía
    ...
    jugador_circulo = []
    for jugador in df_jugadores.sample(n=80000)['Nombre']:  # 80000 jugadores en círculos
