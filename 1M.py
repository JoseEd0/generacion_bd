...
def generar_csvs():
    ...
    compras_membresia = []
    for jugador in df_jugadores.sample(n=500000)['Nombre']:  # 500000 jugadores compran membresía
    ...
    jugador_circulo = []
    for jugador in df_jugadores.sample(n=800000)['Nombre']:  # 800000 jugadores en círculos
